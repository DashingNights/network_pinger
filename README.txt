...
2. open cmd.exe as Administator
3. cd %PATH/TO/DIRECTORY%   <- eg cd E:/path/dir
4. cd %DRIVE_LOCATION%:    <- eg E:
5. run "node index.js
6. Generated output should be exported to .txt with timestamp